      ...
      <main className="flex-1 pt-20">
        ...
        <section className="relative px-6 py-24 md:py-32 text-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-[760px] mx-auto animate-luma-fade-only" style={{ animationDuration: "0.8s" }}>
            ...
            <div className="mt-10 flex flex-col items-center gap-3">
              ...
              <p className="text-sm text-white/70">One-time experience</p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-[960px] mx-auto">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
              {[
                ...
                <div
                  key={t}
                  className="rounded-[16px] bg-white/70 border border-[#E8E3D9]/70 shadow-sm p-6"
                >
                  <p className="text-[#2F2F2F] font-medium">{t}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="max-w-[960px] mx-auto">
            ...
            <div className="mt-12 space-y-4 md:space-y-5 max-w-[720px] mx-auto">
              {[
                ...
                <div
                  key={s.step}
                  className="rounded-[16px] bg-white/70 border border-[#E8E3D9]/70 shadow-sm p-6 md:p-7"
                >
                  <p className="text-xs uppercase tracking-[0.18em] text-[#5a5a5a]">{s.step}</p>
                  <p className="mt-3 text-[#2F2F2F] font-medium">{s.text}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="border-t border-[#E8E3D9] px-6 py-20 md:py-24">
          <div className="max-w-[760px] mx-auto text-center">
            ...
            <p className="mt-8 text-[#5a5a5a] leading-relaxed text-base md:text-lg">
        ...
        <section className="border-t border-[#E8E3D9] px-6 py-20 md:py-24">
          <div className="max-w-[720px] mx-auto text-center">
            ...
            <p className="mt-6 text-[#2F2F2F] text-3xl md:text-4xl font-serif [font-family:var(--font-serif-display)]">
              ₹___
            </p>
            <p className="mt-2 text-[#5a5a5a] text-base">One-time payment</p>
            <div className="mt-10">
              <Link
                href="/couples/checkout"
                className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full bg-[#2F2F2F] text-white text-base font-medium transition-opacity hover:opacity-90 shadow-[0_4px_20px_rgba(47,47,47,0.15)]"
              >
                Unlock Your Shared Insight
                <ArrowRight className="w-4 h-4" />
              </Link>
            </div>
          </div>
